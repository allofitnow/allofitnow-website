...
const ADMIN_EMAIL = process.env.PAYLOAD_ADMIN_EMAIL || 'admin@allofitnow.com';
const ADMIN_PASSWORD = process.env.PAYLOAD_ADMIN_PASSWORD || 'secret123'; // Matches seed-projects.js
