...
const STYLE = [
  '<style id="aoin-cs">',
  '.aoin-cs-overlay{position:fixed;inset:0;background:rgba(0,0,0,.72);z-index:2147483000;display:flex;align-items:center;justify-content:center;}',
  '.aoin-cs-dialog{background:var(--aoin-ink,rgb(10,10,10));color:var(--text-primary,#dde7f4);font-family:' + FONT_BODY + ';max-width:520px;width:calc(100% - 32px);padding:28px;border:1px solid var(--rule,rgba(217,225,234,.22));border-radius:0;margin:16px;}',
  '.aoin-cs-dialog h2{font-size:1.15rem;margin:0 0 10px;color:var(--aoin-white,#fff);font-weight:var(--weight-headline,500);letter-spacing:var(--tracking-headline,.02em);}',
  '.aoin-cs-dialog p{font-size:.92rem;line-height:1.5;margin:0 0 18px;color:var(--aoin-cool-white-80,rgba(217,225,234,.8));}',
  '.aoin-cs-dialog a{color:var(--aoin-cool-white,#dde7f4);}',
  '.aoin-cs-btns{display:flex;gap:10px;flex-wrap:wrap;}',
  '.aoin-cs-btn{flex:1 1 140px;min-height:48px;border:1px solid var(--rule,rgba(217,225,234,.22));border-radius:0;background:transparent;color:var(--text-primary,#dde7f4);font-size:.95rem;font-weight:var(--weight-body,400);cursor:pointer;padding:0 14px;font-family:' + FONT_BODY + ';}',
  '.aoin-cs-btn:focus-visible{outline:3px solid var(--aoin-cool-white-80,rgba(217,225,234,.8));outline-offset:2px;}',
  ...
  '.aoin-cs-fab:hover{transform:translateY(-2px);box-shadow:0 8px 26px rgba(0,0,0,.55),0 0 0 10px rgba(10,10,10,.32);}',
  '.aoin-cs-fab:focus-visible{outline:3px solid var(--aoin-cool-white-80,rgba(217,225,234,.8));outline-offset:2px;}',
